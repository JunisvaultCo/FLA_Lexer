...
/*
  test("preprocessing test") {
    val str = List(
      ("a",List(Left('a'))),
      ("aa",List(Left('a'), Left('a'))),
      ("a|b",List(Left('a'), Right('|'), Left('b'))),
      ("a*",List(Left('a'), Right('*'))),
      ("ab|c",List(Left('a'), Left('b'), Right('|'), Left('c'))),
      ("a|bc",List(Left('a'), Right('|'), Left('b'), Left('c'))),
      ("a|b|c|d",List(Left('a'), Right('|'), Left('b'), Right('|'), Left('c'), Right('|'), Left('d'))),
      ("(a|b)c", List(Right('('), Left('a'), Right('|'), Left('b'), Right(')'), Left('c'))),
      ("a(b|c)", List(Left('a'), Right('('), Left('b'), Right('|'), Left('c'), Right(')'))),
      ("a|b*", List(Left('a'), Right('|'), Left('b'), Right('*'))),
      ("ab*cd*", List(Left('a'), Left('b'), Right('*'), Left('c'), Left('d'), Right('*'))),
      ("a|(b|(c|de))", List(Left('a'), Right('|'), Right('('), Left('b'), Right('|'), Right('('), Left('c'), Right('|'), Left('d'), Left('e'), Right(')'), Right(')'))),
      ("a|(b|c)*", List(Left('a'), Right('|'), Right('('), Left('b'), Right('|'), Left('c'), Right(')'), Right('*'))),
      ("(a|b)(c|d)*", List(Right('('), Left('a'), Right('|'), Left('b'), Right(')'), Right('('), Left('c'), Right('|'), Left('d'), Right(')'), Right('*'))),
      ("a*|b|c", List(Left('a'), Right('*'), Right('|'), Left('b'), Right('|'), Left('c'))),
      ("a*|bc|d", List(Left('a'), Right('*'), Right('|'), Left('b'), Left('c'), Right('|'), Left('d'))),
      ("a*(b|c)d", List(Left('a'), Right('*'), Right('('), Left('b'), Right('|'), Left('c'), Right(')'), Left('d'))),
      ("(ab(b|c)*)*", List(Right('('), Left('a'), Left('b'), Right('('), Left('b'), Right('|'), Left('c'), Right(')'), Right('*'), Right(')'), Right('*'))),
      ("a(a|A)*((bcd*|ecf*)|aA)*", List(Left('a'), Right('('), Left('a'), Right('|'), Left('A'), Right(')'), Right('*'), Right('('), Right('('),
        Left('b'), Left('c'), Left('d'), Right('*'), Right('|'), Left('e'), Left('c'), Left('f'), Right('*'), Right(')'), Right('|'), Left('a'),
        Left('A'), Right(')'), Right('*'))),
      ("eps", List(Left('e'), Left('p'), Left('s'))),
      ("\' \'\'a\'", List(Left(' '), Left('a'))),
      ("\'\n\'a\'\t\'b", List(Left('\n'), Left('a'), Left('\t'), Left('b'))),
      ("[0-9]", List(Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'))),
      ("[a-z]", List(Right('('), Left('a'), Right('|'), Left('b'), Right('|'), Left('c'), Right('|'), Left('d'), Right('|'), Left('e'), Right('|'), Left('f'), Right('|'), Left('g'), Right('|'), Left('h'), Right('|'), Left('i'), Right('|'), Left('j'), Right('|'), Left('k'), Right('|'), Left('l'), Right('|'), Left('m'), Right('|'), Left('n'), Right('|'), Left('o'), Right('|'), Left('p'), Right('|'), Left('q'), Right('|'), Left('r'), Right('|'), Left('s'), Right('|'), Left('t'), Right('|'), Left('u'), Right('|'), Left('v'), Right('|'), Left('w'), Right('|'), Left('x'), Right('|'), Left('y'), Right('|'), Left('z'), Right(')'))),
      ("[A-Z]", List(Right('('), Left('A'), Right('|'), Left('B'), Right('|'), Left('C'), Right('|'), Left('D'), Right('|'), Left('E'), Right('|'), Left('F'), Right('|'), Left('G'), Right('|'), Left('H'), Right('|'), Left('I'), Right('|'), Left('J'), Right('|'), Left('K'), Right('|'), Left('L'), Right('|'), Left('M'), Right('|'), Left('N'), Right('|'), Left('O'), Right('|'), Left('P'), Right('|'), Left('Q'), Right('|'), Left('R'), Right('|'), Left('S'), Right('|'), Left('T'), Right('|'), Left('U'), Right('|'), Left('V'), Right('|'), Left('W'), Right('|'), Left('X'), Right('|'), Left('Y'), Right('|'), Left('Z'), Right(')'))),
      ("0+", List(Right('('), Left('0'), Left('0'), Right('*'), Right(')'))),
      ("0?", List(Right('('), Left('0'), Right('|'), Right('('), Left('e'), Left('p'), Left('s'), Right(')'), Right(')'))),
      ("0?1+", List(Right('('), Left('0'), Right('|'), Right('('), Left('e'), Left('p'), Left('s'), Right(')'), Right(')'), Right('('), Left('1'), Left('1'), Right('*'), Right(')'))),
      ("[0-9]*|b", List(Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Right('*'), Right('|'), Left('b'))),
      ("a([a-z]*|[A-Z]*)z", List(Left('a'), Right('('), Right('('), Left('a'), Right('|'), Left('b'), Right('|'), Left('c'), Right('|'), Left('d'), Right('|'), Left('e'), Right('|'), Left('f'), Right('|'), Left('g'), Right('|'), Left('h'), Right('|'), Left('i'), Right('|'), Left('j'), Right('|'), Left('k'), Right('|'), Left('l'), Right('|'), Left('m'), Right('|'), Left('n'), Right('|'), Left('o'), Right('|'), Left('p'), Right('|'), Left('q'), Right('|'), Left('r'), Right('|'), Left('s'), Right('|'), Left('t'), Right('|'), Left('u'), Right('|'), Left('v'), Right('|'), Left('w'), Right('|'), Left('x'), Right('|'), Left('y'), Right('|'), Left('z'), Right(')'), Right('*'), Right('|'), Right('('), Left('A'), Right('|'), Left('B'), Right('|'), Left('C'), Right('|'), Left('D'), Right('|'), Left('E'), Right('|'), Left('F'), Right('|'), Left('G'), Right('|'), Left('H'), Right('|'), Left('I'), Right('|'), Left('J'), Right('|'), Left('K'), Right('|'), Left('L'), Right('|'), Left('M'), Right('|'), Left('N'), Right('|'), Left('O'), Right('|'), Left('P'), Right('|'), Left('Q'), Right('|'), Left('R'), Right('|'), Left('S'), Right('|'), Left('T'), Right('|'), Left('U'), Right('|'), Left('V'), Right('|'), Left('W'), Right('|'), Left('X'), Right('|'), Left('Y'), Right('|'), Left('Z'), Right(')'), Right('*'), Right(')'), Left('z'))),
      ("[0-9]+('-'[0-9]+)*", List(Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Right('*'), Right(')'), Right('('), Left('-'), Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Right('*'), Right(')'), Right(')'), Right('*'))),
      ("([0-9]*|b+)c?d(da)(\' \'|[A-Z]|\'a\')?", List(Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Right('*'), Right('|'), Right('('), Left('b'), Left('b'), Right('*'), Right(')'), Right(')'), Right('('), Left('c'), Right('|'), Right('('), Left('e'), Left('p'), Left('s'), Right(')'), Right(')'), Left('d'), Right('('), Left('d'), Left('a'), Right(')'), Right('('), Right('('), Left(' '), Right('|'), Right('('), Left('A'), Right('|'), Left('B'), Right('|'), Left('C'), Right('|'), Left('D'), Right('|'), Left('E'), Right('|'), Left('F'), Right('|'), Left('G'), Right('|'), Left('H'), Right('|'), Left('I'), Right('|'), Left('J'), Right('|'), Left('K'), Right('|'), Left('L'), Right('|'), Left('M'), Right('|'), Left('N'), Right('|'), Left('O'), Right('|'), Left('P'), Right('|'), Left('Q'), Right('|'), Left('R'), Right('|'), Left('S'), Right('|'), Left('T'), Right('|'), Left('U'), Right('|'), Left('V'), Right('|'), Left('W'), Right('|'), Left('X'), Right('|'), Left('Y'), Right('|'), Left('Z'), Right(')'), Right('|'), Left('a'), Right(')'), Right('|'), Right('('), Left('e'), Left('p'), Left('s'), Right(')'), Right(')'))),
      ("'('", List(Left('('))),
      ("')'", List(Left(')'))),
      ("'*'", List(Left('*'))),
      ("'|'", List(Left('|'))),
      ("'+'", List(Left('+'))),
      ("'''", List(Left('\''))),
      ("a|'|'", List(Left('a'), Right('|'), Left('|'))),
      ("([0-9]a)+", List(Right('('), Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Left('a'), Right(')'), Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Left('a'), Right(')'), Right('*'), Right(')'))),
      ("a([0-9]a)+", List(Left('a'), Right('('), Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Left('a'), Right(')'), Right('('), Right('('), Left('0'), Right('|'), Left('1'), Right('|'), Left('2'), Right('|'), Left('3'), Right('|'), Left('4'), Right('|'), Left('5'), Right('|'), Left('6'), Right('|'), Left('7'), Right('|'), Left('8'), Right('|'), Left('9'), Right(')'), Left('a'), Right(')'), Right('*'), Right(')'))),
      ("10*+", List(Left('1'), Right('('), Left('0'), Right('*'), Left('0'), Right('*'), Right('*'), Right(')')))
    )
    for (i <- str) yield {
      val prep = Regex.preprocess(Regex.stringToList(i._1))
      assert(prep == i._2, i + "\n" + prep)
    }
  }*/
}
